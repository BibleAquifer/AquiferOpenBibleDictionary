...
Raabe tornou\-se esposa de Salmom e mãe de Boaz. Assim, ela foi uma ancestral de Jesus ([Mt 1\.5](https://ref.ly/Matt1:5)). Raabe é mencionada, junto com Moisés, Davi, Sansão e Samuel, como um exemplo de fé ([Hb 11\.31](https://ref.ly/Heb11:31)). Seu feito é um exemplo de boas obras e justificação ([Tg 2\.25](https://ref.ly/Jas2:25)).
...
* **Associated ACAI Concepts:** Raamá (ID: `person:Raamah`); Raamá (ID: `place:Raamah`); Seba (ID: `person:Sheba`); Sabtá (ID: `person:Sabtah`); Havilá (ID: `person:Havilah`); Sabtecá (ID: `person:Sabteca`)
## Raamias (id: 830459)

RAAMIAS\*
=========

Aquele que retornou com Zorobabel para a Palestina após o cativeiro babilônico ([Ne 7\.7](https://ref.ly/Neh7:7)). Raamias é alternativamente escrito como Reelaías em [Esdras 2\.2](https://ref.ly/Ezra2:2). A forma correta da palavra é incerta. *Veja* Reelaías.

* **Associated Passages:** Esdras 2:2; Neemias 7:7
* **Associated Articles:** Reelaías (ID: `830522@TyndaleBibleDictionary`)

* **Associated ACAI Concepts:** Reelaías (ID: `person:Reelaiah`); Neemias (ID: `person:Nehemiah`); Baana (ID: `person:Baanah.3`); Mispar (ID: `person:Mispar`); Mordecai (ID: `person:Mordecai`); Bilsã (ID: `person:Bilshan`); Reum (ID: `person:Rehum`); Bigvai (ID: `person:Bigvai`); Azarias (ID: `person:Azariah.18`); Seraias (ID: `person:Seraiah.6`); Naamani (ID: `person:Nahamani`); Israel (ID: `person:Israel`); Zorobabel (ID: `person:Zerubbabel.2`)
## Raão (id: 830472)

RAÃO
====

Filho de Sema e pai de Jorqueão ([1Cr 2\.44](https://ref.ly/1Chr2:44)). Ele era um descendente de Judá.

* **Associated Passages:** 1 Crônicas 2:44

* **Associated ACAI Concepts:** Raão (ID: `person:Raham`); Jorqueão (ID: `person:Jorkeam`); Sema (ID: `person:Shema`); Requém (ID: `person:Rekem.2`); Samai (ID: `person:Shammai.2`)
## Rabá (id: 830461)

RABÁ
====

Uma das cidades na região montanhosa atribuída à tribo de Judá como herança ([Js 15\.60](https://ref.ly/Josh15:60)). Sua localização é incerta. Alguns a identificam com Rubute, mencionada nas tábuas de Amarna, ou Khirbet Bir al\-Hilu.
...
* **Associated Articles:** Decápolis* (ID: `161802@TyndaleBibleDictionary`); Filadélfia (ID: `830371@TyndaleBibleDictionary`)
...
Título dado a um certo oficial babilônico, Nergal\-Sarezer, que estava encarregado da segurança de Jeremias durante a queda de Jerusalém ([Jr 39\.3,13](https://ref.ly/Jer39:3,Jer39:13)). O significado do título é incerto.

* **Associated Passages:** Jeremias 39:3; Jeremias 39:13

* **Associated ACAI Concepts:** Rabe-Mague (ID: `person:Rab-mag`); Rabe-Saris (ID: `person:Rab-saris.2`); Nergal-Sarezer (ID: `person:Nergal-shar-ezer.2`); Babilônia (ID: `place:Babylon`); Nebu-sar-sekim (ID: `person:Nebu-sar-sekim`); Sangar (ID: `person:Samgar`)
## Rabino (id: 161861)
...
Cidade que define a fronteira de Issacar ([Js 19\.20](https://ref.ly/Josh19:20)) e talvez identificável com a cidade levítica chamada Daberate ([Js 19\.12](https://ref.ly/Josh19:12); [21\.28](https://ref.ly/Josh21:28); [1Cr 6\.72](https://ref.ly/1Chr6:72)). Se for assim, seu local está próximo ao Monte Tabor na moderna Daburiyya. *Veja* Daberate.

* **Associated Passages:** Josué 19:12; Josué 19:20; Josué 21:28; 1 Crônicas 6:72
* **Associated Articles:** Daberate (ID: `828492@TyndaleBibleDictionary`)

* **Associated ACAI Concepts:** Daberate (ID: `place:Daberath`); Rabite (ID: `place:Rabbith`); Quisião (ID: `place:Kishion`); Ebes (ID: `place:Ebez`)
## Rabôni* (id: 161862)
...
* parte da delegação assíria ([2Rs 18\.17](https://ref.ly/2Kgs18:17)),
* um juiz no portão ([Jeremias 39\.3](https://ref.ly/Jer39:3)),
* o oficial que libertou Jeremias da prisão (versículo [13](https://ref.ly/Jer39:13)), e
* um dos oficiais de Nabucodonosor ([Dn 1\.3,7](https://ref.ly/Dan1:3,Dan1:7)).

* **Associated Passages:** 2 Reis 18:17; Jeremias 39:3; Jeremias 39:13; Daniel 1:3; Daniel 1:7

* **Associated ACAI Concepts:** Rabe-Saris (ID: `person:Rab-saris.2`); Rabe-Saris (ID: `person:Rab-saris`); Azarias (ID: `person:Azariah.20`); Nergal-Sarezer (ID: `person:Nergal-shar-ezer.2`)
## Raca (id: 717251)
...
A de Raabe presente na ARC em [Mateus 1\.5](https://ref.ly/Matt1:5).

*Veja* Raabe (pessoa).

* **Associated Passages:** Mateus 1:5
* **Associated Articles:** Raabe (pessoa) (ID: `830471@TyndaleBibleDictionary`)

* **Associated ACAI Concepts:** Raabe (ID: `person:Rahab`); Obede (ID: `person:Obed`); Boaz (ID: `person:Boaz`); Salmom (ID: `person:Salmon`); Rute (ID: `person:Ruth`)
## Racal (id: 830466)

RACAL
=====

Uma das cidades no sul de Judá onde Davi distribuiu os despojos tomados dos amalequitas derrotados ([1Sm 30\.29](https://ref.ly/1Sam30:29)). A cidade é chamada Carmelo na Septuaginta.

* **Associated Passages:** 1 Samuel 30:29

* **Associated ACAI Concepts:** Carmelo (ID: `place:Carmel`); Jerameel (ID: `person:Jerahmeel`); Jerahmeelites (ID: `group:Jerahmeel`)
## Racate (id: 830478)

RACATE
======

Uma das 19 cidades atribuídas à tribo de Naftali como herança ([Js 19\.35](https://ref.ly/Josh19:35)). A cidade servia como uma área de proteção contra ataques militares na margem ocidental do Mar da Galileia. A tradição judaica identifica Racate com Tiberíades, mas estudiosos modernos preferem sua localização em Khirbet el\-Quneitireh ou Tell Eklatiyah.

* **Associated Passages:** Josué 19:35

* **Associated ACAI Concepts:** Hamate (ID: `place:Hammath`); Tiberíades (ID: `place:Tiberias`); Zer (ID: `place:Zer`); Quinerete (ID: `place:Chinnereth`); Zidim (ID: `place:Ziddim`)
## Racom (id: 830479)

RACOM
=====

Uma das cidades atribuídas à tribo de Dã ([Js 19\.46](https://ref.ly/Josh19:46)). Hoje é identificada como Tell Er\-Ragguat, 2,4 quilômetros ao norte da foz do Rio Yarkon.

* **Associated Passages:** Josué 19:46

* **Associated ACAI Concepts:** Racom (ID: `place:Rakkon`); Me-Jarcom (ID: `place:Me-jarkon`); Jope (ID: `place:Joppa`)
## Radai (id: 830469)

RADAI
=====

Quinto dos sete filhos de Jessé e irmão de Davi, da tribo de Judá ([1Cr 2\.14](https://ref.ly/1Chr2:14)).

* **Associated Passages:** 1 Crônicas 2:14

* **Associated ACAI Concepts:** Radai (ID: `person:Raddai`); Natanael (ID: `person:Nethanel.2`)
## Rafa (id: 830498)

RAFA\*
======

Forma alternativa de Refaías, filho de Bineá, em [1 Crônicas 8\.37](https://ref.ly/1Chr8:37). *Veja* Refaías \#4.

* **Associated Passages:** 1 Crônicas 8:37
* **Associated Articles:** Refaías (ID: `830539@TyndaleBibleDictionary`)

* **Associated ACAI Concepts:** Rafa (ID: `person:Raphah`); Eleasa (ID: `person:Eleasah.2`); Azel (ID: `person:Azel`); Bineá (ID: `person:Binea`); Mosa (ID: `person:Moza.2`)
## Rafa (id: 717257)
...
* **Associated Articles:** Refaías (ID: `830539@Unknown`)

* **Associated ACAI Concepts:** Rafa (ID: `person:Raphah`); Rôs (ID: `person:Rosh`); Naamã (ID: `person:Naaman`); Gera (ID: `person:Gera`)
## Rafael (id: 830497)

RAFAEL
======

Personagem principal no livro Deuterocanônico de Tobias. Quando Deus ouviu as orações de Tobite e Sara, o anjo Rafael foi enviado em seu auxílio ([Tb 3\.17](https://ref.ly/Tob3:17)). Este anjo, disfarçado como um parente confiável chamado Azarias, acompanhou o filho de Tobite, Tobias, em sua jornada para recuperar uma soma de dinheiro de Gabael ([5\.1](https://ref.ly/Tob5:1-Tob5:22)). Viajando com o cachorro de Tobias, os dois acamparam à beira de um rio ([6\.1](https://ref.ly/Tob6:1-Tob6:18)). Um peixe saltou da água e tentou engolir o pé de Tobias. Por sugestão de Rafael, Tobias eviscerou o peixe e separou sua bílis, coração e fígado para uso futuro como remédios. Quando questionado por Tobias, o anjo revelou que “a bílis é para ungir os olhos de uma pessoa quando manchas brancas se espalharam sobre eles” (v. [8](https://ref.ly/Tob6:8)). Este era exatamente o mal que estava afligindo o pai de Tobias, Tobite ([2\.9–10](https://ref.ly/Tob2:9-Tob2:10)).

A jornada continuou, e Rafael tornou\-se o casamenteiro de Tobias e Sara ([6\.9](https://ref.ly/Tob6:9-Tob6:18)). Na casa de Sara, os dois se casaram. No quarto da noiva, o coração e o fígado do peixe foram úteis para exorcizar o demônio que havia impedido o sucesso dos sete casamentos anteriores de Sara ([8\.2](https://ref.ly/Tob8:2)).

Enquanto isso, Rafael continuou na missão de recuperar o dinheiro de Tobite de Gabael ([9\.1](https://ref.ly/Tob9:1-Tob9:6)). Ele teve sucesso nessa tarefa. Finalmente, Tobias e sua nova esposa, Sara, acompanhados pelo anjo Rafael, com o cachorro seguindo fielmente seus passos, retornaram à casa de Tobit ([11\.1](https://ref.ly/Tob11:1-Tob11:18)). Lá, Tobias aplicou o remédio de fel de peixe do anjo nos olhos de seu pai. A visão de Tobite foi imediatamente restaurada. A pedido de Tobite, Tobias ofereceu recompensar o disfarçado Rafael com metade do dinheiro recuperado de Gabael. Nesse momento, o anjo revelou sua verdadeira identidade a eles, dizendo: “Eu sou Rafael, um dos sete anjos que estão em serviço diante do Senhor,” e acrescentando, “Observe que eu não comi nenhum alimento; o que vocês viram foi uma aparição” ([12\.15,19](https://ref.ly/Tob12:15,Tob12:19)). Rafael então ascendeu fora de vista.
...
Filho de Semaías e porteiro do templo na época de Davi ([1Cr 26\.7–8](https://ref.ly/1Chr26:7-1Chr26:8)).

* **Associated Passages:** 1 Crônicas 26:7-8

* **Associated ACAI Concepts:** Rafael (ID: `person:Rephael`); Eliú (ID: `person:Elihu.3`); Elzabade (ID: `person:Elzabad.2`)
## Rafana (id: 830499)
...
* **Associated ACAI Concepts:** Rafu (ID: `person:Raphu`); Palti (ID: `person:Palti`)
## Ragaú (id: 830470)

RAGAÚ
=====

Grafia alternativa de Reú presente na ARC, filho de Pelegue, em [Lucas 3\.35](https://ref.ly/Luke3:35).

*Veja* Reú.

* **Associated Passages:** Lucas 3:35
* **Associated Articles:** Reú (ID: `683073@TyndaleBibleDictionary`)

* **Associated ACAI Concepts:** Reú (ID: `person:Reu`); Selá (ID: `person:Shelah.2`); Serugue (ID: `person:Serug`); Eber (ID: `person:Eber`); Pelegue (ID: `person:Peleg`)
## Rainha (id: 717250)
...
Grafia alternativa para Ramá presente em traduções mais antigas, uma cidade benjamita, em [Mateus 2\.18](https://ref.ly/Matt2:18).

*Veja* Ramá \#1.

* **Associated Passages:** Mateus 2:18
* **Associated Articles:** Ramá (ID: `717253@TyndaleBibleDictionary`)

* **Associated ACAI Concepts:** Ramah (ID: `place:Ramah.2`); rogar (ID: `keyterm:AskFor`); Raquel (ID: `person:Rachel`); exortar (ID: `keyterm:Encourage`); Ramá (ID: `place:Ramah`)
## Ramá (id: 717253)
...
* **Associated ACAI Concepts:** Ramá (ID: `place:Ramah`); Ramah (ID: `place:Ramah.2`); Jorão (ID: `person:Joram.3`); Ramote-Gileade (ID: `place:Ramoth-gilead`)
## Ramá do Neguebe, Ramá do Sul (id: 830480)

RAMÁ DO NEGUEBE, RAMÁ DO SUL\*
==============================

Nomes alternativos para Baalate\-Beer, uma cidade no território de Simeão, em [Josué 19\.8](https://ref.ly/Josh19:8). *Veja* Baalate\-Beer.

* **Associated Passages:** Josué 19:8
* **Associated Articles:** Baalate-Beer (ID: `827984@TyndaleBibleDictionary`)

* **Associated ACAI Concepts:** Neguebe (ID: `place:Negeb`); Baalath-beer (ID: `place:Baalath-beer`); Ramah (ID: `place:Ramah.2`); Simeão (ID: `group:Simeon`); to cause to possess (ID: `keyterm:Possess`)
## Ramataim (id: 830482)

RAMATAIM
========

Tradução alternativa do grego “Rathamin” ([1Mc 11\.34](https://ref.ly/1Macc11:34)). *Veja* Rathamin.

* **Associated Passages:** 1 Macabeus 11:34
* **Associated Articles:** Ramataim (ID: `830503@TyndaleBibleDictionary`)
...
Um território transferido do domínio de Samaria para Judá por Demétrio da Síria. Uma carta de Demétrio para seu ajudante Lástenes autorizando a transferência é mencionada em [1 Macabeus 11\.34](https://ref.ly/1Macc11:34). É também o local de nascimento de Samuel e lar de Elcana e Ana ([1Sm 1\.1,19](https://ref.ly/1Sam1:1,1Sam1:19); [2\.19](https://ref.ly/1Sam2:19)). Nesse caso, figura proeminentemente na história do AT, pois lá Saul primeiro conheceu Samuel ([9\.6,10](https://ref.ly/1Sam9:6,1Sam9:10)), lá Samuel se retirou após sua última ruptura com Saul, e lá está localizado o túmulo de Samuel ([25\.1](https://ref.ly/1Sam25:1)). Variantes textuais Armataim e Ramata são parcialmente explicadas pela transposição de *m* e *t* na versão Septuaginta. Dois locais modernos são recomendados para o antigo distrito: Beit Rime, 20,9 quilômetros a leste e norte de Lida, e Ramallah, 12,9 quilômetros ao norte de Jerusalém.
...
Nome alternativo para Ramá, cidade natal de Samuel, em [1 Samuel 1\.1](https://ref.ly/1Sam1:1). *Veja* Ramá \#5.

* **Associated Passages:** 1 Samuel 1:1
* **Associated Articles:** Ramá (ID: `717253@TyndaleBibleDictionary`)

* **Associated ACAI Concepts:** Ramá (ID: `place:Ramah`); Toú (ID: `person:Tohu`); Zufe (ID: `person:Zuph`); Jeroão (ID: `person:Jeroham`); Elcana (ID: `person:Elkanah.2`); Efraim (ID: `group:Ephraim`); Eliú (ID: `person:Elihu`); Efraim (ID: `person:Ephraim`)
...
* **Associated ACAI Concepts:** Ramate-Mispa (ID: `place:Ramath-mizpeh`); Bethonim (ID: `place:Betonim`); Maanaim (ID: `place:Mahanaim`); Lo-Debar (ID: `place:Lo-debar`)
## Ramatita (id: 830483)
...
* **Associated ACAI Concepts:** Ramathites (ID: `group:Ramathites`); Shiphmites (ID: `group:Shiphmites`); Zabdi (ID: `person:Zabdi.3`); Simei (ID: `person:Shimei.12`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Ramessés (ID: `place:Rameses`); Ramassés (ID: `place:Raamses`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Ramias (ID: `person:Ramiah`); Malquias (ID: `person:Malchijah.4`); Miamim (ID: `person:Mijamin.2`); Benaia (ID: `person:Benaiah.8`); Jezias (ID: `person:Izziah`); Parós (ID: `person:Parosh`); Eleazar (ID: `person:Eleazar.7`); Israel (ID: `person:Israel`)
## Ramo (id: 716953)
...
* **Associated ACAI Concepts:** Ramá (ID: `place:Ramah`); Ram (ID: `person:Ram`); Ram (ID: `person:Ram.2`); Ram (ID: `person:Ram.3`); Ramote (ID: `place:Remeth`)
...
2\. Nome alternativo para Baalate\-Beer, uma cidade no Neguebe, em [1 Samuel 30\.27](https://ref.ly/1Sam30:27). *Veja* Baalate\-Beer.

3\. Nome alternativo (ou alteração textual) de Jarmute, uma cidade levítica, em [1 Crônicas 6\.73](https://ref.ly/1Chr6:73). *Veja* Jarmute \#2.

* **Associated Passages:** 1 Samuel 30:27; 1 Crônicas 6:73
* **Associated Articles:** Baalate-Beer (ID: `827984@TyndaleBibleDictionary`); Jarmute (ID: `829428@TyndaleBibleDictionary`); Ramote-Gileade (ID: `759956@TyndaleBibleDictionary`)

* **Associated ACAI Concepts:** Ramote (ID: `place:Remeth`); Baalath-beer (ID: `place:Baalath-beer`); En-Ganim (ID: `place:En-gannim.2`); Betel (ID: `place:Bethel.2`)
## Ramote do Neguebe, Ramote do Sul (id: 830490)

RAMOTE DO NEGUEBE , RAMOTE DO SUL\*
===================================

Nomes alternativos para Baalate\-Beer, um local desconhecido no território de Simeão, em [1 Samuel 30\.27](https://ref.ly/1Sam30:27). *Veja* Baalate\-Beer.

* **Associated Passages:** 1 Samuel 30:27
* **Associated Articles:** Baalate-Beer (ID: `827984@TyndaleBibleDictionary`)

* **Associated ACAI Concepts:** Neguebe (ID: `place:Negeb`); Betel (ID: `place:Bethel.2`); Baalath-beer (ID: `place:Baalath-beer`)
...
1. Um ancestral do rei Davi ([Rt 4\.19](https://ref.ly/Ruth4:19); [1Cr 2\.9–10](https://ref.ly/1Chr2:9-1Chr2:10)), listado na genealogia de Cristo em Mateus ([Mt 1\.3–4](https://ref.ly/Matt1:3-Matt1:4); chamado Arão em [Lc 3\.33](https://ref.ly/Luke3:33)).

    *Veja* Genealogia de Jesus Cristo.

2. O filho mais velho de Jerameel ([1Cr 2\.25–27](https://ref.ly/1Chr2:25-1Chr2:27)), e possivelmente o sobrinho do \#1 acima.
3. Chefe da família de Eliú, um dos amigos de Jó ([Jó 32\.2](https://ref.ly/Job32:2)).
...
* **Associated ACAI Concepts:** Hezrom (ID: `person:Hezron.2`); Ram (ID: `person:Ram`)
...
Um lugar e seu povo, provavelmente na Cilícia, que foi devastado pelo exército de Holofernes ([Jt 2\.23](https://ref.ly/Jdt2:23)).
...
* **Associated ACAI Concepts:** Mouse (ID: `fauna:Mouse`); Mongoose (ID: `fauna:Mongoose`); Lizard (ID: `fauna:Lizard`); kind (ID: `keyterm:Kind.2`)
## Razis (id: 830506)

RAZIS
=====

Um ancião judeu ferozmente patriótico que foi procurado pelo general sírio Nicanor por sua oposição ao helenismo ([2Mc 14\.37–46](https://ref.ly/2Macc14:37-2Macc14:46)). Ele cometeu suicídio, atirando suas próprias entranhas nos espectadores, em vez de enfrentar a prisão pelos soldados sírios.
...
* **Associated ACAI Concepts:** Reabias (ID: `person:Rehabiah`); Issias (ID: `person:Isshiah.4`); Eliezer (ID: `person:Eliezer.3`)
## Reaías (id: 830507)

REAÍAS
======

1\. Filho de Sobal e pai de Jaate da tribo de Judá ([1Cr 4\.2](https://ref.ly/1Chr4:2)), possivelmente identificável com Haroé ([2\.52](https://ref.ly/1Chr2:52)).

2\. Rubenita, filho de Mica e pai de Baal ([1Cr 5\.5](https://ref.ly/1Chr5:5)).

3\. Chefe ou fundador de uma família de servos do templo que retornou com Zorobabel do cativeiro na Babilônia ([Ed 2\.47](https://ref.ly/Ezra2:47); [Ne 7\.50](https://ref.ly/Neh7:50)).

* **Associated Passages:** 1 Crônicas 2:52; 1 Crônicas 4:2; 1 Crônicas 5:5; Esdras 2:47; Neemias 7:50

* **Associated ACAI Concepts:** Reaías (ID: `person:Reaiah.3`); Reaías (ID: `person:Reaiah.2`); Haroé (ID: `person:Haroeh`)
## Reba (id: 759959)
...
* **Associated ACAI Concepts:** Reba (ID: `person:Reba`); Requém (ID: `person:Rekem`); Hur (ID: `person:Hur.3`); Evi (ID: `person:Evi`); Zur (ID: `person:Zur.2`)
## Rebeca (id: 683068)
...
* **Associated ACAI Concepts:** Reca (ID: `place:Recah`); Teína (ID: `person:Tehinnah`); Paseia (ID: `person:Paseah`); Ir-Nahash (ID: `person:Ir-nahash`); Bete-Rafa (ID: `person:Beth-rapha`); Estom (ID: `person:Eshton`)
## Recabe (id: 830512)

RECABE
======

1. Um filho de Rimom. Com seu irmão Baaná, Recabe liderava bandos de saqueadores sob o comando de Isbosete, filho do rei Saul. Na esperança de agradar a Davi, eles mataram Isbosete. No entanto, essa morte irritou Davi. Davi ordenou a execução dos dois homens ([2Sm 4\.1–3,5–12](https://ref.ly/2Sam4:1-2Sam4:3,2Sam4:5-2Sam4:12)).
2. O pai de Jonadabe. Jonadabe ajudou Jeú a matar muitos dos seguidores do rei Acabe em Samaria ([2Rs 10\.15–27](https://ref.ly/2Kgs10:15-2Kgs10:27)).

    O profeta Jeremias refere\-se aos seguidores e descendentes de Recabe como *recabitas*. Eles obedeceram à ordem de Jonadabe de não beber vinho, construir casas, plantar colheitas ou cultivar vinhedos. Em vez disso, viviam em tendas como nômades (pessoas que se movem de um lugar para outro). Jeremias elogiou os recabitas por permanecerem leais aos ensinamentos de sua família. Ele disse que eles eram mais fiéis do que o povo de Judá e Jerusalém, que não havia obedecido a Deus. Jeremias afirmou que Deus traria julgamento contra Judá e Jerusalém. Mas ele prometeu que os recabitas seriam mantidos em segurança. ([Jr 35\.1–19](https://ref.ly/Jer35:1-Jer35:19)).
...
* **Associated Articles:** Recabe (ID: `830512@TyndaleBibleDictionary`)
...
A condição humana era de total incapacidade de reparar o relacionamento rompido e hostil com Deus. Cristo foi a ponte. Sua missão de substituição foi a razão de sua encarnação (vir à Terra como humano). Seu sofrimento e morte sacrificial, confirmados por sua ressurreição, redimiram a humanidade ([Rm 4\.25](https://ref.ly/Rom4:25)). Cristo não sofreu a morte como um destino comum compartilhado por todas as pessoas. Ele sofreu a morte como a penalidade pelo pecado.

Seu sacrifício substitutivo por todos os pecados é central para as Escrituras. Tudo depende do fato de que o ponto de virada para a humanidade veio de Deus, que reconciliou o mundo consigo mesmo através de Cristo. Isso não é apenas uma ideia esperançosa, mas um evento real ([Is 53\.6](https://ref.ly/Isa53:6); [2Co 5\.21](https://ref.ly/2Cor5:21); [Hb 9\.12–14](https://ref.ly/Heb9:12-Heb9:14); [1Pe 1\.19](https://ref.ly/1Pet1:19)). Foi a solução de Deus para o terrível conflito entre um Deus justo e irado e pessoas pecadoras e ofensivas.

As Escrituras consistentemente enfatizam a natureza abrangente da obra de Cristo, que expiou os pecados de todas as pessoas ([Jo 3\.16](https://ref.ly/John3:16); [1 João 2\.2](https://ref.ly/1John2:2)). Cristo é o escudo que protege os pecadores da justa ira de Deus. A expiação de Cristo não foi apenas suficiente porque Deus a aceitou. Foi, na verdade, o pagamento completo pelo pecado ([Mt 20\.28](https://ref.ly/Matt20:28); [Rm 3\.25](https://ref.ly/Rom3:25); [Hb 7\.26–28](https://ref.ly/Heb7:26-Heb7:28); [1Tm 2\.6](https://ref.ly/1Tim2:6); [1Jo 2\.2](https://ref.ly/1John2:2)).

O evangelho é a mensagem que informa aos pecadores sobre a reconciliação de Deus com eles através de Cristo. Ele persuade poderosamente os pecadores a aceitarem essa verdade pela fé. Como o apóstolo Paulo coloca: “Que Deus estava reconciliando o mundo consigo mesmo em Cristo, não imputando aos homens os seus pecados. E ele nos confiou a mensagem da reconciliação. Portanto, somos embaixadores de Cristo, como se Deus estivesse fazendo seu apelo por nosso intermédio. Imploramos em nome de Cristo: Reconciliem\-se com Deus!” ([2Co 5\.19–20](https://ref.ly/2Cor5:19-2Cor5:20)).
...
Chefe de uma família que retornou a Jerusalém com Zorobabel após o exílio ([Ed 2\.2](https://ref.ly/Ezra2:2)); também chamado de Raamias ([Ne 7\.7](https://ref.ly/Neh7:7)). *Veja* Raamias.

* **Associated Passages:** Esdras 2:2; Neemias 7:7
* **Associated Articles:** Raamias (ID: `830459@TyndaleBibleDictionary`)

* **Associated ACAI Concepts:** Reelaías (ID: `person:Reelaiah`); Neemias (ID: `person:Nehemiah`); Mordecai (ID: `person:Mordecai`); Bilsã (ID: `person:Bilshan`); Reum (ID: `person:Rehum`); Baana (ID: `person:Baanah.3`); Mispar (ID: `person:Mispar`); Bigvai (ID: `person:Bigvai`); Israel (ID: `person:Israel`); Seraias (ID: `person:Seraiah.6`); Zorobabel (ID: `person:Zerubbabel.2`); Azarias (ID: `person:Azariah.18`); Josué (ID: `person:Joshua.5`)
## Refa (id: 830538)
...
* **Associated ACAI Concepts:** Refa (ID: `person:Rephah`); Resefe (ID: `person:Resheph`); Telá (ID: `person:Telah`); Taã (ID: `person:Tahan.2`)
## Refaías (id: 830539)

REFAÍAS
=======

1\. Filho de Jesaías e descendente de Salomão ([1Cr 3\.21](https://ref.ly/1Chr3:21)).

2\. O filho de Isi é um capitão da tribo de Simeão que liderou 500 israelitas para destruir os amalequitas no Monte Seir ([1Cr 4\.42–43](https://ref.ly/1Chr4:42-1Chr4:43)).

3\. O filho de Tola é um guerreiro da tribo de Issacar nos dias de Davi ([1Cr 7\.1–2](https://ref.ly/1Chr7:1-1Chr7:2)).

4\. Filho de Bineá e pai de Eleasa, um descendente de Saul ([1Cr 9\.43](https://ref.ly/1Chr9:43)); também chamado de Rafa em [1Cr 8\.37](https://ref.ly/1Chr8:37) (ARA “Rafa”).

5\. O filho de Hur, que trabalhou no muro de Jerusalém durante os dias de Neemias ([Ne 3\.9](https://ref.ly/Neh3:9)).

* **Associated Passages:** 1 Crônicas 3:21; 1 Crônicas 8:37; 1 Crônicas 9:43; Neemias 3:9; 1 Crônicas 4:42-43; 1 Crônicas 7:1-2

* **Associated ACAI Concepts:** Refaías (ID: `person:Rephaiah.2`); Refaías (ID: `person:Rephaiah.4`); Refaías (ID: `person:Rephaiah.3`); Refaías (ID: `person:Rephaiah.5`); Rafa (ID: `person:Raphah`); Jesaías (ID: `person:Jeshaiah.2`)
## Refaim (id: 683069)
...
* **Associated ACAI Concepts:** Refaías (ID: `person:Rephaiah.2`); Refaías (ID: `person:Rephaiah.3`); Refaías (ID: `person:Rephaiah.4`); Refaías (ID: `person:Rephaiah.5`); Rifate (ID: `person:Riphath`)
...
* **Associated Articles:** Festas E Festivais De Israel (ID: `125259@TyndaleBibleDictionary`); Comida E Preparação De Alimentos (ID: `125261@TyndaleBibleDictionary`); Ceia Do Senhor, A (ID: `161840@TyndaleBibleDictionary`); Páscoa (ID: `830313@TyndaleBibleDictionary`)
...
* **Associated ACAI Concepts:** Regém (ID: `person:Regem`); Gesã (ID: `person:Geshan`); Efá (ID: `person:Ephah.3`); Pelete (ID: `person:Pelet`); Saafe (ID: `person:Shaaph`); Jotão (ID: `person:Jotham.3`); Jadai (ID: `person:Jahdai`)
...
* **Associated ACAI Concepts:** Ameleque (ID: `place:Amalek`); Efraim (ID: `group:Ephraim`); Efraim (ID: `person:Ephraim`)
...
* **Associated ACAI Concepts:** Italy (ID: `place:Italy`); Name (ID: `keyterm:Name`)
## Régio (id: 816076)
...
* **Associated ACAI Concepts:** Régio (ID: `place:Rhegium`); Puteóli (ID: `place:Puteoli`)
## Registro (id: 828704)
...
* **Associated Articles:** Censo (ID: `716968@TyndaleBibleDictionary`)
...
Oficial que apoiou Salomão quando Adonias tentou se tornar rei perto do final do reinado de Davi ([1Rs 1\.8](https://ref.ly/1Kgs1:8)).

* **Associated Passages:** 1 Reis 1:8

* **Associated ACAI Concepts:** Rei (ID: `person:Rei`); Simei (ID: `person:Shimei.6`); Benaia (ID: `person:Benaiah`); Jeoiada (ID: `person:Jehoiada`); Davi (ID: `person:David`)
...
Instrumento usado para medir o tempo instalado pelo Rei Acaz de Judá (735–715 a.C.) no palácio real de Jerusalém. Alguns sugerem que esse indicador de tempo não era um relógio de sol, mas uma escadaria. A hora do dia era determinada pela posição da sombra de algum objeto projetada nas escadas. Por ordem de Isaías, o Senhor milagrosamente fez a sombra recuar dez degraus, confirmando divinamente ao Rei Ezequias de Judá (715–686 a.C.) que ele se recuperaria de sua doença, viveria mais 15 anos e seria livrado da ameaça assíria ([2Rs 20\.7–11](https://ref.ly/2Kgs20:7-2Kgs20:11); [Is 38\.7–8](https://ref.ly/Isa38:7-Isa38:8)).
...
O pai do rei Peca de Israel governou de 737 a 732 a.C. Peca assumiu o poder ao matar secretamente o rei anterior ([2Rs 15\.25–37](https://ref.ly/2Kgs15:25-2Kgs15:37)). Mais tarde, ele atacou Jerusalém com seu exército ([Is 7\.1–9](https://ref.ly/Isa7:1-Isa7:9)).
...
Cidade fronteiriça no território de Issacar ([Js 19\.21](https://ref.ly/Josh19:21)), e provavelmente a mesma que Ramote ([1Cr 6\.73](https://ref.ly/1Chr6:73)), também chamada de Jarmute. *Veja* Jarmute \#2.

* **Associated Passages:** Josué 19:21; 1 Crônicas 6:73
* **Associated Articles:** Jarmute (ID: `829428@TyndaleBibleDictionary`)

* **Associated ACAI Concepts:** Ramote (ID: `place:Remeth`); En-Ganim (ID: `place:En-gannim.2`); Bete-Pasês (ID: `place:Beth-pazzez`)
...
* **Associated ACAI Concepts:** Renfã (ID: `deity:Rephan`); Image (ID: `realia:Image`); Sicute (ID: `deity:Sikkuth`)
...
* **Associated ACAI Concepts:** Bete-Reobe (ID: `place:Beth-rehob`); Reobe (ID: `place:Rehob.2`); Reobe (ID: `place:Rehob.3`); Tobe (ID: `place:Tob`)
...
* **Associated ACAI Concepts:** Reobe (ID: `person:Rehob`); Reobe (ID: `person:Rehob.2`); Zobá (ID: `place:Zobah`); Hadadezer (ID: `person:Hadadezer`)
## Reobote (id: 658719)
...
* **Associated ACAI Concepts:** Reobote (ID: `place:Rehoboth.2`); Reobote (ID: `place:Rehoboth`); Nínive (ID: `place:Nineveh`)
...
* **Associated ACAI Concepts:** Nínive (ID: `place:Nineveh`); Calá (ID: `place:Calah`)
## Réptil (id: 830542)
...
* **Associated Articles:** Animais (ID: `125233@TyndaleBibleDictionary`); Áspide (ID: `827915@TyndaleBibleDictionary`); Lagartixa (ID: `759766@TyndaleBibleDictionary`); Lagarto (ID: `829777@TyndaleBibleDictionary`); Cobra (ID: `830879@TyndaleBibleDictionary`)
...
* **Associated ACAI Concepts:** Raquém (ID: `person:Rakem`); Ulão (ID: `person:Ulam`); Seres (ID: `person:Sheresh`); Perez (ID: `person:Peresh`); Maaca (ID: `person:Maacah.5`); Maquir (ID: `person:Machir`)
## Requém (lugar) (id: 830531)

REQUÉM (lugar)
==============

Uma das 26 cidades atribuídas à tribo de Benjamim como herança ([Js 18\.27](https://ref.ly/Josh18:27)).

* **Associated Passages:** Josué 18:27

* **Associated ACAI Concepts:** Requém (ID: `place:Rekem`); Irpeel (ID: `place:Irpeel`); Tarala (ID: `place:Taralah`)
...
* **Associated ACAI Concepts:** Requém (ID: `person:Rekem`); Requém (ID: `person:Rekem.2`); Reba (ID: `person:Reba`); Sema (ID: `person:Shema`)
## Resa (id: 830549)

RESA
====

Um descendente de Zorobabel e um antepassado de Jesus Cristo ([Lc 3\.27](https://ref.ly/Luke3:27)).
...
* **Associated ACAI Concepts:** Resefe (ID: `person:Resheph`); Refa (ID: `person:Rephah`); Telá (ID: `person:Telah`); Taã (ID: `person:Tahan.2`)
## Resém (id: 658720)
...
* **Associated ACAI Concepts:** Resém (ID: `place:Resen`); Calá (ID: `place:Calah`); Nínive (ID: `place:Nineveh`)
## Resgate (id: 124404)
...
* **Associated ACAI Concepts:** Recabe (ID: `person:Rechab`); Recabe (ID: `person:Rechab.2`); Recabe (ID: `person:Rechab.3`)
...
* **Associated Articles:** Mortos, Lugar Dos (ID: `161799@TyndaleBibleDictionary`); Escatologia (ID: `815952@TyndaleBibleDictionary`); Segunda Vinda De Cristo* (ID: `124408@TyndaleBibleDictionary`); Espírito (ID: `830918@TyndaleBibleDictionary`)
...
* **Associated ACAI Concepts:** Reú (ID: `person:Reu`); Serugue (ID: `person:Serug`); Pelegue (ID: `person:Peleg`)
## Reuel (id: 759955)
...
* **Associated ACAI Concepts:** Reuel (ID: `person:Reuel.3`); Jetro (ID: `person:Jethro`); Reuel (ID: `person:Reuel.4`); Deuel (ID: `person:Deuel`)
## Reum (id: 830529)

REUM
====

1\. Um dos 12 líderes judeus que retornaram do cativeiro com Zorobabel ([Ed 2\.2](https://ref.ly/Ezra2:2); [Ne 7\.7](https://ref.ly/Neh7:7), onde “Neum” é aparentemente um erro de copista). *Veja* Neum.

2\. Comandante persa que, junto com Sinsai, o escriba, escreveu a Artaxerxes I, reclamando do projeto de reconstrução do templo dos judeus e prometendo consequências terríveis caso o projeto fosse concluído. A resposta do rei interrompeu a construção até o segundo ano do reinado de Dario ([Ed 4\.8–23](https://ref.ly/Ezra4:8-Ezra4:23)).

3\. Levita identificado como filho de Bani, que ajudou a reparar o muro de Jerusalém sob a direção de Neemias ([Ne 3\.17](https://ref.ly/Neh3:17)).

4\. Líder que colocou seu selo no pacto de Esdras ([Ne 10\.25](https://ref.ly/Neh10:25)).

5\. Sacerdote que acompanhou Zorobabel ([Ne 12\.3](https://ref.ly/Neh12:3)); em outros lugares, ele foi chamado de Harim. *Veja* Harim \#5.

* **Associated Passages:** Esdras 2:2; Neemias 3:17; Neemias 7:7; Neemias 10:25; Neemias 12:3; Esdras 4:8-23
* **Associated Articles:** Harim (ID: `829057@TyndaleBibleDictionary`); Neum (ID: `830153@TyndaleBibleDictionary`)

* **Associated ACAI Concepts:** Reum (ID: `person:Rehum.2`); Reum (ID: `person:Rehum`); Reum (ID: `person:Rehum.3`); Reum (ID: `person:Rehum.4`)
## Reumá (id: 683072)
...
* **Associated ACAI Concepts:** Reumá (ID: `person:Reumah`); Teba (ID: `person:Tebah`); Maaca (ID: `person:Maacah`); Gaã (ID: `person:Gaham`); Taás (ID: `person:Tahash`)
...
2\. Pai de alguns dos servos do templo que serviram em tempos pós\-exílicos ([Ed 2\.48](https://ref.ly/Ezra2:48); [Ne 7\.50](https://ref.ly/Neh7:50)).

* **Associated Passages:** Esdras 2:48; Neemias 7:50; Isaías 7:4; Isaías 7:1-9; 2 Crônicas 28:5-6; 2 Crônicas 28:5-15; Isaías 8:1-8

* **Associated ACAI Concepts:** Rezim (ID: `person:Rezin`); Rezim (ID: `person:Rezin.2`)
## Rezom (id: 830548)

REZOM
=====

Filho de Eliada, que se estabeleceu como governante de Damasco e Síria após a morte de Hadadezer, rei de Zobá, por Davi. Rezom foi um adversário designado por Deus que desprezava Israel e foi um problema constante para Salomão durante seu reinado ([1Rs 11\.23–25](https://ref.ly/1Kgs11:23-1Kgs11:25)).

* **Associated Passages:** 1 Reis 11:23-25

* **Associated ACAI Concepts:** Rezom (ID: `person:Rezon`)
## Riacho (id: 828253)
...
* **Associated ACAI Concepts:** Arabá (ID: `place:Arabah`); Mar Morto (ID: `place:SaltSea`); Ribeiro de Arabá (ID: `place:BrookOfTheArabah`)
...
* **Associated ACAI Concepts:** Torrentes dos Salgueiros (ID: `place:BrookOfTheWillows`); Poplar (ID: `flora:Poplar`)
## Ribai (id: 830551)

RIBAI
=====

Um benjamita da cidade de Gibeá. Ribai era o pai de Etai, que foi um dos valentes do rei Davi ([2Sm 23\.29](https://ref.ly/2Sam23:29); [1Cr 11\.31](https://ref.ly/1Chr11:31)).

* **Associated Passages:** 2 Samuel 23:29; 1 Crônicas 11:31

* **Associated ACAI Concepts:** Ribai (ID: `person:Ribai`); Itai (ID: `person:Ittai.2`); Gibeah (ID: `place:Gibeah.2`); Benjamim (ID: `person:Benjamin`); Benjamim (ID: `group:Benjamin`); Benaia (ID: `person:Benaiah.2`); Baana (ID: `person:Baanah.2`); Helebe (ID: `person:Heleb`)
...
* **Associated ACAI Concepts:** Ribeiro do Egito (ID: `place:BrookOfEgypt`); Egito (ID: `place:Egypt`); Rio Eufrates (ID: `place:Euphrates`)
...
* **Associated ACAI Concepts:** Ribla (ID: `place:Riblah.2`); Ribla (ID: `place:Riblah`); Babilônia (ID: `place:Babylon`)
## Rifate (id: 658723)
...
* **Associated ACAI Concepts:** Rifate (ID: `person:Riphath`); Togarma (ID: `person:Togarmah`); Asquenaz (ID: `person:Ashkenaz`)
## Rim (id: 717130)
...
* **Associated ACAI Concepts:** Dimna (ID: `place:Dimnah`); Merari (ID: `person:Merari`); Zebulom (ID: `group:Zebulun`); Zebulom (ID: `person:Zebulun`)
## Rimom (Lugar) (id: 830554)

RIMOM (Lugar)
=============

1\. Cidade atribuída primeiro a Judá e depois a Simeão ([Js 15\.32](https://ref.ly/Josh15:32); [19\.7](https://ref.ly/Josh19:7); [1Cr 4\.32](https://ref.ly/1Chr4:32)). Esses versículos referem\-se a dois lugares, Ain e Rimom, mas isso foi provavelmente um erro de escriba para a mesma cidade, Rimom (veja [Js 19\.7](https://ref.ly/Josh19:7)). 

2\. Cidade no território atribuído à tribo de Zebulom como herança ([Js 19\.13](https://ref.ly/Josh19:13)); alternativamente chamada de Dimna em [Josué 21\.35](https://ref.ly/Josh21:35).

3\. Grande caverna a cerca de 19 quilômetros ao norte de Jerusalém e 3 quilômetros ao sul da bíblica Efraim (moderna Taiyiba), também chamada de Rocha de Rimom. Seiscentos refugiados da cidade de Gibeá encontraram abrigo na caverna por quatro meses ([Jz 20\.45–47](https://ref.ly/Judg20:45-Judg20:47); [21\.13](https://ref.ly/Judg21:13)).

* **Associated Passages:** Josué 15:32; Josué 19:13; Josué 21:35; Juízes 21:13; 1 Crônicas 4:32; Juízes 20:45-47
* **Associated Articles:** En-Rimom (ID: `828702@Unknown`)

* **Associated ACAI Concepts:** Rock of Rimmon (ID: `place:Rimmon.3`); Dimna (ID: `place:Dimnah`); Ain (ID: `place:Ain.2`)
## Rimom (pessoa) (id: 830553)

RIMOM (pessoa)
==============

1. Um benjamita da cidade de Beerote. Seus dois filhos, Baaná e Recabe, mataram Isbosete ([2Sm 4\.2,5,9](https://ref.ly/2Sam4:2,2Sam4:5,2Sam4:9)). Isbosete era filho do rei Saul e tornou\-se rei de Israel após a morte de seu pai.
2. Um deus adorado pelos sírios de Damasco. Naamã era capitão do exército sírio. Ele e seu rei frequentemente visitavam o templo de Rimom ([2Rs 5\.18](https://ref.ly/2Kgs5:18)).
...
* **Associated ACAI Concepts:** Rimom (ID: `person:Rimmon`); Rimom (ID: `deity:Rimmon`); Beerote (ID: `place:Beeroth`); Recabe (ID: `person:Rechab`)
## Rimom-Metoar (id: 830535)

RIMOM\-METOAR\*
===============

Tradução ARC para “Rimom na direção a Neá,” em [Josué 19\.13](https://ref.ly/Josh19:13). *Veja* Rimom (lugar) \#2.
...
* **Associated ACAI Concepts:** Rimom-Perez (ID: `place:Rimmon-perez`); Ritma (ID: `place:Rithmah`)
## Rimom, Rocha de (id: 830555)

RIMOM, Rocha de
===============

Grande caverna ao norte de Jerusalém ([Jz 20\.45–47](https://ref.ly/Judg20:45-Judg20:47); [21\.13](https://ref.ly/Judg21:13)). *Veja* Rimom (lugar) \#3.
...
* **Associated ACAI Concepts:** Rina (ID: `person:Rinnah`); Tilom (ID: `person:Tilon`); Simão (ID: `person:Shimon`); Ben-Hanã (ID: `person:Ben-hanan`); Isi (ID: `person:Ishi.2`); Amnon (ID: `person:Amnon.2`); Ben-Zoete (ID: `person:Ben-zoheth`); Zoete (ID: `person:Zoheth`)
...
* **Associated ACAI Concepts:** Egito (ID: `place:Egypt`); Rio Eufrates (ID: `place:Euphrates`); SENHOR (ID: `deity:Lord`); Covenant (ID: `keyterm:Covenant`); Abraão (ID: `person:Abraham`)
...
* Os israelitas atravessaram o Jordão ao entrar na terra Prometida ([Js 3\.14–17](https://ref.ly/Josh3:14-Josh3:17)).
* Os vaus do Jordão foram os locais de conflito na guerra de Jefté e os gileaditas contra os efraimitas ([Jz 12\.1–6](https://ref.ly/Judg12:1-Judg12:6)).
* O profeta Elias procurou refúgio do rei Acabe de Israel junto ao riacho de Querite, a leste do Jordão ([1Rs 17\.1–5](https://ref.ly/1Kgs17:1-1Kgs17:5)).
* Elias foi levado ao céu em um redemoinho após atravessar o Jordão com Eliseu em terra seca ([2Rs 2\.6–12](https://ref.ly/2Kgs2:6-2Kgs2:12)).
* Naamã, o general sírio, banhou\-se no Jordão por ordem de Eliseu, e sua lepra foi curada ([2Rs 5\.8–14](https://ref.ly/2Kgs5:8-2Kgs5:14)).
* Eliseu fez o ferro do machado flutuar aqui ([2Rs 6\.1–7](https://ref.ly/2Kgs6:1-2Kgs6:7)).

Eventos do Novo Testamento perto do Rio Jordão
----------------------------------------------

* Jesus foi batizado por João Batista no Jordão ([Mt 3\.13–17](https://ref.ly/Matt3:13-Matt3:17)).
* Pedro confessou que Jesus era o "Cristo, o Filho do Deus vivo" em Cesareia de Filipos. Esta conversa ocorre perto de uma das fontes do Jordão, Nahr Baniyas ([Mt 16\.13–20](https://ref.ly/Matt16:13-Matt16:20)).
* Jesus curou dois cegos em Jericó, que fica perto do Jordão ([Mt 20\.29–34](https://ref.ly/Matt20:29-Matt20:34)).
* Jesus também visitou Zaqueu em Jericó ([Lc 19\.1–10](https://ref.ly/Luke19:1-Luke19:10)).
...
* **Associated Articles:** Mamom (ID: `829869@TyndaleBibleDictionary`); Dinheiro (ID: `683037@TyndaleBibleDictionary`); Pobres, Os (ID: `161858@TyndaleBibleDictionary`); Salários (ID: `683114@TyndaleBibleDictionary`); Riquezas (ID: `161865@TyndaleBibleDictionary`)
...
Após a morte de Saul, houve um conflito entre dois líderes: Isbosete e Abner. Isbosete acusou Abner de ter relações sexuais com Rispa. Naquela época, isso poderia ser visto como uma tentativa de usurpar o lugar do rei. Abner ficou furioso e prometeu ajudar Davi a se tornar rei em seu lugar ([2Sm 3\.7–10](https://ref.ly/2Sam3:7-2Sam3:10)).
...
Rispa ficou com os corpos de seus filhos. Ela os protegeu de aves e animais selvagens até que o rei Davi os enterrasse adequadamente ([2Sm 21\.8–11](https://ref.ly/2Sam21:8-2Sam21:11)).
...
* **Associated ACAI Concepts:** Ritma (ID: `place:Rithmah`); Rimom-Perez (ID: `place:Rimmon-perez`)
## Rizia (id: 830558)
...
* **Associated ACAI Concepts:** Rizia (ID: `person:Rizia`); Ará (ID: `person:Arah`); Sual (ID: `person:Shual`); Haniel (ID: `person:Hanniel.2`)
## Rízia (id: 830546)

RÍZIA\*
=======

Ortografia da ARC de Rizia, filho de Ula, em [1 Crônicas 7\.39](https://ref.ly/1Chr7:39). *Veja* Rizia.

* **Associated Passages:** 1 Crônicas 7:39
* **Associated Articles:** Rizia (ID: `830558@TyndaleBibleDictionary`)
...
No entanto, o povo construiu altos e santuários pagãos por toda a terra. Eles começaram a se envolver nas práticas religiosas corruptas das nações pagãs ao seu redor, incluindo a homossexualidade ([1Rs 14\.22–24](https://ref.ly/1Kgs14:22-1Kgs14:24)).

Logo, Roboão abandonou a lei do Senhor, e todo Israel o seguiu ([2Cr 12\.1](https://ref.ly/2Chr12:1)). Roboão era filho de Salomão, um pai preocupado que se tornou cada vez mais negligente com as coisas espirituais. A mãe de Roboão era Naamá, uma princesa pagã amonita que, presumivelmente, não tinha qualquer percepção espiritual ([1Rs 14\.21](https://ref.ly/1Kgs14:21)). O exemplo de seu pai, que mantinha um harém e tinha numerosos filhos, também teve um impacto sobre ele. Roboão teve 18 esposas, 60 concubinas, 28 filhos e 60 filhas. Ele passou uma quantidade considerável de tempo providenciando acomodações para eles nas cidades fortificadas de Judá ([2Cr 11\.21–23](https://ref.ly/2Chr11:21-2Chr11:23)).

Com o tempo, a apostasia de Judá tornou\-se tão grande que Deus trouxe julgamento sobre a nação na forma de uma invasão estrangeira. No quinto ano de Roboão (c. 926 a.C.), Sisaque I (Sheshonk I) do Egito invadiu a Palestina com 1\.200 carros e 60\.000 homens ([1Rs 14\.25](https://ref.ly/1Kgs14:25); [2Cr 12\.2–3](https://ref.ly/2Chr12:2-2Chr12:3)).
...
O arrependimento de Roboão foi apenas temporário. As Escrituras indicam que seus últimos anos foram caracterizados pelo mal ([2Cr 12\.14](https://ref.ly/2Chr12:14)), e que seu filho e sucessor, Abias, “andou em todos os pecados que seu pai cometeu antes dele” ([1Rs 15\.3](https://ref.ly/1Kgs15:3)). Provavelmente, os pecados de seu pai não teriam sido condenados se os últimos 12 anos de Roboão tivessem sido um bom exemplo para seu filho em amadurecimento.
...
* **Associated ACAI Concepts:** Dodanim (ID: `group:Dodanim`); Javã (ID: `person:Javan`); Társis (ID: `person:Tarshish`); Quitim (ID: `group:Kittim`); Elisá (ID: `person:Elishah`)
## Rode (id: 816077)
...
* **Associated ACAI Concepts:** Rodes (ID: `place:Rhodes`); Dodanim (ID: `group:Dodanim`); Elisá (ID: `person:Elishah`); Javã (ID: `person:Javan`); Társis (ID: `person:Tarshish`); Dedã (ID: `place:Dedan`)
## Rôdoco (id: 830550)

RÔDOCO
======

Um traidor judeu que forneceu informações militares aos sírios sobre a fortificação de Bete\-Zur por Judas Macabeu. Quando descoberto, foi considerado culpado e preso ([2Mc 13\.21](https://ref.ly/2Macc13:21)).
...
* **Associated ACAI Concepts:** Rohgah (ID: `person:Rohgah`); Aram (ID: `person:Aram.3`); Aí (ID: `person:Ahi.2`); Somer (ID: `person:Shomer.2`); Jeubá (ID: `person:Jehubbah`)
## Rogelim (id: 830564)
...
* **Associated ACAI Concepts:** Rogelim (ID: `place:Rogelim`); Barzillai (ID: `person:Barzillai`); Gileade (ID: `place:Gilead`); Gileadites (ID: `group:Gilead`); Sobi (ID: `person:Shobi`)
## Rolinhas (id: 831129)
...
* **Associated ACAI Concepts:** Romanti-Ézer (ID: `person:Romamti-ezer`); Hotir (ID: `person:Hothir`); Maloti (ID: `person:Mallothi`); Maaziote (ID: `person:Mahazioth`); Matanias (ID: `person:Mattaniah.2`); Jerimote (ID: `person:Jerimoth.4`); Hemã (ID: `person:Heman.3`); Hanani (ID: `person:Hanani.2`); Uziel (ID: `person:Uzziel.4`)
## Romãzeira (id: 830403)
...
* **Associated ACAI Concepts:** Rôs (ID: `person:Rosh`); Arde (ID: `person:Ard`); Gera (ID: `person:Gera`); Asbel (ID: `person:Ashbel`); Hupim (ID: `person:Huppim`); Eí (ID: `person:Ehi`); Bequer (ID: `person:Becher`); Mupim (ID: `person:Muppim`); Naamã (ID: `person:Naaman`); Bela (ID: `person:Bela`)
## Rosa (id: 830570)
...
* **Associated Articles:** Plantas (ID: `125318@TyndaleBibleDictionary`); Tulipa (ID: `831126@TyndaleBibleDictionary`)
...
* **Associated Articles:** Mandamentos, Os dez (ID: `716972@TyndaleBibleDictionary`); Direito penal e punição (ID: `716982@TyndaleBibleDictionary`)
...
* **Associated Articles:** Damasco (Lugar) (ID: `682900@TyndaleBibleDictionary`)

* **Associated ACAI Concepts:** Rua Direita (ID: `place:Straight`); Tarso (ID: `group:Tarsus`); Judas (ID: `person:Judas.4`); Tarso (ID: `place:Tarsus`); Jesus (ID: `person:Jesus.2`); orar (ID: `keyterm:Pray`); House (ID: `realia:House`); Name (ID: `keyterm:Name`); Paulo (ID: `person:Paul`); straightness (ID: `keyterm:Straightness`)
...
* **Associated ACAI Concepts:** Rúben (ID: `group:Reuben`); Rúben (ID: `person:Reuben`); Baal-Meon (ID: `place:Baal-meon`)
...
1. Um dos filhos de Simão de Cirene ([Mc 15\.21](https://ref.ly/Mark15:21)).
2. Um cristão saudado por Paulo na carta aos Romanos. Paulo acrescentou um comentário especial e carinhoso sobre a mãe dele ([Rm 16\.13](https://ref.ly/Rom16:13)). Este Rufo romano pode ser o mesmo referido como o filho de Simão de Cirene em [Marcos 15\.21](https://ref.ly/Mark15:21).

* **Associated Passages:** Marcos 15:21; Romanos 16:13

* **Associated ACAI Concepts:** Rufo (ID: `person:Rufus`); Rufo (ID: `person:Rufus.2`)
## Ruma (id: 830575)

RUMA
====

Lar de Pedaías, pai de Zebida, mãe de Jeoaquim ([2Rs 23\.36](https://ref.ly/2Kgs23:36)). Alguns o identificam com Arumá, perto de Siquém (cf. [Jz 9\.41](https://ref.ly/Judg9:41)) ou com Khirbet el\-Rumah na Galileia.

* **Associated Passages:** Juízes 9:41; 2 Reis 23:36

* **Associated ACAI Concepts:** Dumah (ID: `place:Dumah.2`); Arumá (ID: `place:Arumah`); Zebida (ID: `person:Zebidah`)
## Rute (pessoa) (id: 830577)

Rute (pessoa)
=============

Uma moabita e viúva de Malom, filho de Noemi e Elimeleque, que eram efratitas de Belém. Noemi e Elimeleque mudaram\-se para Moabe devido a uma fome em Judá. Após a morte de Elimeleque e dos dois filhos de Noemi, Noemi voltou para Belém com sua nora Rute durante a colheita da cevada ([Rt 1\.4–22](https://ref.ly/Ruth1:4-Ruth1:22)). Enquanto respigava nos campos de cevada de Boaz, Rute encontrou favor aos seus olhos ([Rt 2\.2–22](https://ref.ly/Ruth2:2-Ruth2:22)). Ela mais tarde se casou com Boaz. Ele, como o parente mais próximo, comprou a propriedade de Noemi para mantê\-la na família ([Rt 4\.5–13](https://ref.ly/Ruth4:5-Ruth4:13)). Rute é mencionada na lista de família de Cristo em Mateus como a mãe de Obede e bisavó de Davi ([Mt 1\.5](https://ref.ly/Matt1:5)).

*Veja também* Genealogia de Jesus Cristo; Livro de Rute.

* **Associated Passages:** Mateus 1:5; Rute 1:4-22; Rute 2:2-22; Rute 4:5-13
* **Associated Articles:** Genealogia de Jesus Cristo (ID: `682940@TyndaleBibleDictionary`); Rute, Livro de (ID: `481577@TyndaleBibleDictionary`)
