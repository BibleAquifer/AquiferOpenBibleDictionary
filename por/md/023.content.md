...
* **Associated ACAI Concepts:** Vaizata (ID: `person:Vaizatha`); Arisai (ID: `person:Arisai`)
...
* **Associated ACAI Concepts:** Jordan River (ID: `place:Jordan`); Gade (ID: `person:Gad`)
...
* **Associated ACAI Concepts:** Vale de Soreque (ID: `place:SorekValley`)
...
* **Associated ACAI Concepts:** Vale de Savé (ID: `place:Shaveh`); King’s Valley (ID: `place:KingsValley`); Quedorlaomer (ID: `person:Chedorlaomer`)
