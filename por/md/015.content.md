...
* **Associated ACAI Concepts:** Nadabe (ID: `person:Nadab`); Nadabe (ID: `person:Nadab.3`); Nadabe (ID: `person:Nadab.4`); Nadabe (ID: `person:Nadab.2`)
...
* **Associated ACAI Concepts:** Naftali (ID: `group:Naphtali`); Naftali (ID: `person:Naphtali`); Quedes (ID: `place:Kedesh`); Judá (ID: `group:Judah`)
