...
* **Associated ACAI Concepts:** Taã (ID: `person:Tahan.2`); Taã (ID: `person:Tahan`)
...
* **Associated ACAI Concepts:** Ereque (ID: `place:Erech`); Pérsia (ID: `place:Persia`); Elamites (ID: `group:Elam`); Persians (ID: `group:Persia`); Elam (ID: `place:Elam`)
...
* **Associated ACAI Concepts:** Tifsa (ID: `place:Tiphsah`); Tifsa (ID: `place:Tiphsah.2`)
...
* **Associated ACAI Concepts:** Timna (ID: `person:Timna.3`); Timna (ID: `person:Timna`); Timna (ID: `person:Timna.2`)
