...
* **Associated ACAI Concepts:** Fanuel (ID: `person:Phanuel`)
...
* **Associated ACAI Concepts:** Hofra (ID: `person:Hophra`); Egito (ID: `place:Egypt`); SENHOR (ID: `deity:Lord`); Babilônia (ID: `place:Babylon`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Fígelo (ID: `person:Phygelus`)
...
* **Associated ACAI Concepts:** Éden (ID: `place:Eden`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Fortunato (ID: `person:Fortunatus`)
