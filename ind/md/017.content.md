...
* **Associated ACAI Concepts:** Yudas (ID: `person:Judas`); Alfeus (ID: `person:Alphaeus`); Yakobus (ID: `person:James.2`); Bartolomeus (ID: `person:Bartholomew`); Filipus (ID: `person:Philip`); Tomas (ID: `person:Thomas`); Andreas (ID: `person:Andrew`); Simon (ID: `person:Simon.2`)
## Takhta (id: 369134)
