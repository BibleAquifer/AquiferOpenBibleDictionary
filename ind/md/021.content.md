...
* **Associated ACAI Concepts:** Zelot (ID: `group:Zealot`); Simon (ID: `person:Simon.2`)
## Zelotes (id: 369139)
...
* **Associated ACAI Concepts:** Simon (ID: `person:Simon.2`); Alfeus (ID: `person:Alphaeus`); Matius (ID: `person:Matthew`); Yakobus (ID: `person:James.2`); Tomas (ID: `person:Thomas`); Bartolomeus (ID: `person:Bartholomew`)
