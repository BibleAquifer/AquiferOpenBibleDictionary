...
* **Associated ACAI Concepts:** Izhar (ID: `person:Izhar`); Amram (ID: `person:Amram`); Hebron (ID: `person:Hebron`); Kohath (ID: `person:Kohath`); Izharites (ID: `group:Izhar`); Uzziel (ID: `person:Uzziel`); Amramites (ID: `group:Amram`); Hebronites (ID: `group:Hebron`); Uzzielites (ID: `group:Uzziel`)
