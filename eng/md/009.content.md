...
* **Associated ACAI Concepts:** Izhar (ID: `person:Izhar`); Amram (ID: `person:Amram`); Kohath (ID: `person:Kohath`); Hebron (ID: `person:Hebron`); Izharites (ID: `group:Izhar`); Uzziel (ID: `person:Uzziel`); Amramites (ID: `group:Amram`); Hebronites (ID: `group:Hebron`); Uzzielites (ID: `group:Uzziel`)
