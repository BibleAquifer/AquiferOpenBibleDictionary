...
* **Associated ACAI Concepts:** Gate of Jeshanah (ID: `place:YeshanahGate`); Sheep Gate (ID: `place:SheepGate`); Ephraim Gate (ID: `place:EphraimGate`); Fish Gate (ID: `place:FishGate`); Gate of the Guard (ID: `place:GuardGate`)
