...
* **Associated ACAI Concepts:** Gate of Jeshanah (ID: `place:YeshanahGate`); Fish Gate (ID: `place:FishGate`); Ephraim Gate (ID: `place:EphraimGate`); Sheep Gate (ID: `place:SheepGate`); Gate of the Guard (ID: `place:GuardGate`)
