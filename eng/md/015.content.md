...
* **Associated ACAI Concepts:** Gate of Jeshanah (ID: `place:YeshanahGate`); Gate of the Guard (ID: `place:GuardGate`); Ephraim Gate (ID: `place:EphraimGate`); Sheep Gate (ID: `place:SheepGate`); Fish Gate (ID: `place:FishGate`)
