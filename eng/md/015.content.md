...
* **Associated ACAI Concepts:** Gate of Jeshanah (ID: `place:YeshanahGate`); Ephraim Gate (ID: `place:EphraimGate`); Gate of the Guard (ID: `place:GuardGate`); Sheep Gate (ID: `place:SheepGate`); Fish Gate (ID: `place:FishGate`)
