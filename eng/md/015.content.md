...
* **Associated ACAI Concepts:** Gate of Jeshanah (ID: `place:YeshanahGate`); Gate of the Guard (ID: `place:GuardGate`); Fish Gate (ID: `place:FishGate`); Ephraim Gate (ID: `place:EphraimGate`); Sheep Gate (ID: `place:SheepGate`)
