...
* **Associated ACAI Concepts:** Gate of Jeshanah (ID: `place:YeshanahGate`); Ephraim Gate (ID: `place:EphraimGate`); Gate of the Guard (ID: `place:GuardGate`); Fish Gate (ID: `place:FishGate`); Sheep Gate (ID: `place:SheepGate`)
