...
* **Associated ACAI Concepts:** Gate of Jeshanah (ID: `place:YeshanahGate`); Fish Gate (ID: `place:FishGate`); Gate of the Guard (ID: `place:GuardGate`); Ephraim Gate (ID: `place:EphraimGate`); Sheep Gate (ID: `place:SheepGate`)
