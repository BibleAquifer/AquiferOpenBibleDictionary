...
* **Associated ACAI Concepts:** Gate of the Guard (ID: `place:GuardGate`); Gate of Jeshanah (ID: `place:YeshanahGate`); Sheep Gate (ID: `place:SheepGate`); Fish Gate (ID: `place:FishGate`); Ephraim Gate (ID: `place:EphraimGate`)
