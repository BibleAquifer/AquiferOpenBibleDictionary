...
* **Associated ACAI Concepts:** Euphrate (ID: `place:Euphrates`); Égypte (ID: `place:Egypt`)
...
* **Associated ACAI Concepts:** forêt d'Éphraïm (ID: `place:ForestEphraim`); Éphraïm (ID: `group:Ephraim`)
...
* **Associated ACAI Concepts:** tour des fours (ID: `place:TowerOfTheOvens`)
...
* **Associated ACAI Concepts:** porte du fumier (ID: `place:DungGate`); porte de la vallée (ID: `place:ValleyGate`)
