...
* **Associated ACAI Concepts:** Yuda (ID: `person:Judas`); Alfayo (ID: `person:Alphaeus`); Tomaso (ID: `person:Thomas`); Bartholomayo (ID: `person:Bartholomew`); Mathayo (ID: `person:Matthew`)
...
* **Associated ACAI Concepts:** Togama (ID: `person:Togarmah`); nyumba (ID: `place:Beth-togarmah`)
