...
* **Associated ACAI Concepts:** Yuda (ID: `person:Judas`); Tomaso (ID: `person:Thomas`); Alfayo (ID: `person:Alphaeus`); Bartholomayo (ID: `person:Bartholomew`); Mathayo (ID: `person:Matthew`)
...
* **Associated ACAI Concepts:** Tirasi (ID: `person:Tiras`); Tubali (ID: `person:Tubal`)
